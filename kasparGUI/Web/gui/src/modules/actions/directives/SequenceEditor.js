...
define(function(require) {
        ...
        var SequenceEditor = function(SequenceOrder, Action, language) {
            return {
                template: template,
                restrict: 'E',
                scope: {
                ...
                controller: function($scope) {
                    ...
                    $scope.toggleAddSelect = function(action) {
                        if (action && $scope.sequence && (action == $scope.sequence || action.id == $scope.sequence.id)) {
                            return;
                        }
        ...
        return ['SequenceOrder', 'Action', 'language', SequenceEditor];
    });
