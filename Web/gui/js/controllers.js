define([ 'angular', 'models', 'proxyServices', 'displayServices',  'angularUIRouter'], function(angular, models, proxyServices, displayServices, angularUIRouter) {
	...
	//
	.controller('operatorController', [ '$scope', 'Operator', 'User', 'proxyObjectResolver', function($scope, Operator, User, proxyObjectResolver) {
	...
	//
	.controller('actionController', [ '$scope', '$http', '$q', '$timeout', 'Action', 'ActionType', function($scope, $http, $q, $timeout, Action, ActionType) {
		$scope.action = '';
		$scope.actions = Action.query();
	...
	//
	.controller('settingsController', [ '$q', '$scope', 'Setting', 'Robot', 'proxyObjectResolver', function($q, $scope, Setting, Robot, proxyObjectResolver) {
		$scope.proxyObjectResolver = proxyObjectResolver;
