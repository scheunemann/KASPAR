...
root = handlers.Index(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'index.html'))
...
root.demos = handlers.StaticFiles(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'development-bundle'))
